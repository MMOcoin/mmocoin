...
static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // MmoCoin: 2 days
static const int64 nTargetSpacing = 120; // MmoCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mmocoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2427e7ababad27b7fca441b97a74851cbba115322473a8fa3393e793e5381640");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Nov. 12, 2013 The 9%: Congress's Approval Rating Hits the Single Digits";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1384577089; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1384577089;
            block.nNonce   = 250790;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4a10ea2005c4141370607c3cd9c82c9c1005ec77ef6570604df4adf7dd7857e9"));
